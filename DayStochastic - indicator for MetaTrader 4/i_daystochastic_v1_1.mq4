   ...
   for(int i=0; i<limit; i++)
     {
      ...
      //----
      Buffer1[i] = iStochastic(NULL, 0, barsday, InpDPeriod, InpSlowing, Method, Price_field, 0, i);
      Buffer2[i] = iStochastic(NULL, 0, barsday, InpDPeriod, InpSlowing, Method, Price_field, 1, i);
     }
//----
   return(0);
  }
