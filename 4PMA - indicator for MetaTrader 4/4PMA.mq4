...
extern int p1_ma=1;//Period() in minutes
extern int p2_ma=5;//Period() in minutes
extern int p3_ma=15;//Period() in minutes
...
//+------------------------------------------------------------------+
  void column()  {
   //..................Time Frame Columns.................................................     
   string column_down, column_up;
   column_down=(string)Bid+" "; column_up=(string)Ask+" ";
   ObjectCreate(column_down+(string)p1_ma,OBJ_RECTANGLE,0,t1_p1,Bid,t2_p1,0);
   ObjectSet(column_down+(string)p1_ma,OBJPROP_COLOR,Red);
   ObjectCreate(column_up+(string)p1_ma,OBJ_RECTANGLE,0,t1_p1,Ask,t2_p1,Ask*1.5);
   ObjectSet(column_up+(string)p1_ma,OBJPROP_COLOR,Green);
   ObjectCreate(column_down+(string)p2_ma,OBJ_RECTANGLE,0,t1_p2,0,t2_p2,Bid);
   ObjectSet(column_down+(string)p2_ma,OBJPROP_COLOR,Red);
   ObjectCreate(column_up+(string)p2_ma,OBJ_RECTANGLE,0,t1_p2,Ask,t2_p2,Ask*1.5);
   ObjectSet(column_up+(string)p2_ma,OBJPROP_COLOR,Green);
   ObjectCreate(column_down+(string)p3_ma,OBJ_RECTANGLE,0,t1_p3,Bid,t2_p3,0);
   ObjectSet(column_down+(string)p3_ma,OBJPROP_COLOR,Red);
   ObjectCreate(column_up+(string)p3_ma,OBJ_RECTANGLE,0,t1_p3,Ask,t2_p3,Ask*1.5);
   ObjectSet(column_up+(string)p3_ma,OBJPROP_COLOR,Green);
   ObjectCreate(column_down+(string)p4_ma,OBJ_RECTANGLE,0,t1_p4,Bid,t2_p4,0);
   ObjectSet(column_down+(string)p4_ma,OBJPROP_COLOR,Red);
   ObjectCreate(column_up+(string)p4_ma,OBJ_RECTANGLE,0,t1_p4,Ask,t2_p4,Ask*1.5);
  ObjectSet(column_up+(string)p4_ma,OBJPROP_COLOR,Green);}//end column();
//---- done
//+------------------------------------------------------------------+