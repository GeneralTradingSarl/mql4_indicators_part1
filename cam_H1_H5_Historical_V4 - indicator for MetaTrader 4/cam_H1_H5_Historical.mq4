...
//---
   SetIndexStyle(1,DRAW_LINE,0,2,clrGreen);
   SetIndexBuffer(1,H4Buffer);
//---
   SetIndexStyle(2,DRAW_LINE,0,2,clrGreen);
   SetIndexBuffer(2,H3Buffer);
//---
   SetIndexStyle(3,DRAW_LINE,0,2,clrGreen);
   SetIndexBuffer(3,H2Buffer);
//---
   SetIndexStyle(4,DRAW_LINE,0,2,clrGreen);
   SetIndexBuffer(4,H1Buffer);
//---
   SetIndexStyle(5,DRAW_LINE,STYLE_DASH,1,clrYellow);
