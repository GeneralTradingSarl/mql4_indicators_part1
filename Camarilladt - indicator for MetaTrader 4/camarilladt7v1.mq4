...
extern double  GMTshiftSun = 1;   // sun into mon cams use this corrected  
extern double  GMTshift = 0;      // value for fri data
...
extern bool DisplayFibLevels_1_3 = true; 
...
extern color MidPivotColor = DarkGray;
...
double r10 = 0, r11 = 0, r12 = 0, r13 = 0, r14 = 0, r15 = 0, r16 = 0;
double s1 = 0, s2 = 0, s3 = 0, s4 = 0, s5 = 0, s6 = 0, s7 = 0, s8 = 0, s9 = 0;
double s10 = 0, s11 = 0, s12 = 0, s13 = 0, s14 = 0, s15 = 0, s16 = 0;
double R;
//+------------------------------------------------------------------+
...
//---- TODO: add your code here
   ...
   double today_open = 0;
   double Q = 0, S = 0, R = 0, M2 = 0, M3 = 0, S1 = 0, R1 = 0, M1 = 0, M4 = 0;
   double S2 = 0, R2 = 0, M0 = 0, M5 = 0, S3 = 0, R3 = 0, nQ = 0, nD = 0; 
   double D = 0, R4 = 0, S4 = 0;
...
//---- Get new daily prices & calculate pivots
   if(DayOfWeek() == 1)  
       shift_corrected = GMTshiftSun;
   else 
       if((DayOfWeek() == 2) && (Minute() >= 5)) 
           shift_corrected = GMTshift;
   ...
   if((CamTargets) && (ListCamTargets) && (StandardPivots) && (ListStandardPivots))     
     {
       Comment("High= ",yesterday_high,"    Previous Days Range= ",nQ,"\nLow= ",
               yesterday_low,"    Current Days Range= ",nD,"\nClose= ",yesterday_close,
               "\n\nH5 ",H5,"\nH4 ",H4,"\nH3 ",H3,"\n\nL3 ",L3,"\nL4 ",L4,"\nL5 ",L5,
               "\n\n\n\nR4 ", R4,"\nR3 ", R3,"\nR2 ", R2,"\nR1 ", R1,"\nPivot ", P,
               "\nS1 ", S1,"\nS2 ", S2,"\nS3 ", S3,"\nS4 ", S4);
     }
       ...
       if((CamTargets) && (ListCamTargets) && (StandardPivots) && !(ListStandardPivots))     
         {
           ...
           if((CamTargets) && (ListCamTargets) && !(StandardPivots))     
             {
               Comment("High= ",yesterday_high,"    Previous Days Range= ",nQ,
               ...
               if(!(CamTargets) && (StandardPivots) && (ListStandardPivots))     
                 {
                   Comment("High= ",yesterday_high,"    Previous Days Range= ",nQ,
                   "\nLow= ",yesterday_low,"    Current Days Range= ",nD,"\nClose= ",
                   yesterday_close, "\n\nR4 ", R4,"\nR3 ", R3,"\nR2 ", R2,"\nR1 ", 
           ...
           if(ObjectFind("FibS12 label") != 0)
             {
               ...
               ObjectSetText("FibS12 label", "Fib S10", FibFontSize, "Arial", FibFontColor);
             }
           else
             {
